      ...
      <nav className="bg-white shadow-sm px-6 py-4 fixed w-full top-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-3">
            <Link to="/login" className="px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium">
              Iniciar Sesión
            </Link>
            <Link to="/register" className="px-6 py-2 bg-white text-green-600 rounded-lg hover:bg-gray-50 transition-colors font-medium border border-green-600">
              Registrarse
            </Link>
          </div>
        </div>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10 text-center text-white">
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <Link to="/login" className="px-8 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors font-medium text-lg">
              Comenzar ahora
            </Link>
            <Link to="/register" className="px-8 py-3 bg-white/20 backdrop-blur-sm hover:bg-white/30 text-white rounded-lg transition-colors font-medium text-lg border border-white/50">
              Registrarse
            </Link>
          </div>
        </div>
