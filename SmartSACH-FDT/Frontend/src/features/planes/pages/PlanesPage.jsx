  ...
  const planes = [
    {
      ...
      precio: '$10.00',
      periodo: 'por mes',
      descripcion: 'Ideal para hogares que necesitan flexibilidad',
      features: [
        '✅ Recolección 2 veces por semana',
        '✅ 3 rutas disponibles',
        '✅ Mapa en tiempo real',
    ...
    },
    {
      nombre: 'Plan Anual',
      precio: '$100.00',
      periodo: 'por año (2 meses gratis)',
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-white py-12 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          Suscríbete a SmartSACH y disfruta de una gestión inteligente de recolección en Chiriquí.
        </p>
          ...
          {planes.map((plan, index) => (
            <div
              ...
              className={`bg-white rounded-2xl shadow-xl overflow-hidden transition-transform hover:scale-105 ${
                plan.popular ? 'border-4 border-green-500 relative' : 'border border-gray-200'
              }`}
            >
              {plan.badge && (
              ...
              <div className="p-8">
                ...
                <div className="mt-4">
                  <span className="text-4xl font-bold text-green-700">{plan.precio}</span>
                  <span className="text-gray-500 text-sm ml-2">{plan.periodo}</span>
                </div>
        ...
        <p className="text-center text-gray-400 text-xs mt-12">
          © 2026 SmartSACH - Servicios Ambientales de Chiriquí
        </p>
      </div>
    </div>
  );
